...
import com.service.gabriel.products.dto.ReserveStockRequest;
...
public class ProductController {
	...
	public ApiResponse<ProductResponse> reserveStock(
			@PathVariable String id,
			@Valid @RequestBody ReserveStockRequest request,
			@RequestHeader(value = "Authorization", required = false) String authorizationHeader) {
		jwtService.validateAuthorizationHeader(authorizationHeader);
		return ApiResponse.ok("Estoque reservado com sucesso", productService.reserveStock(id, request.quantity()));
	}
}
